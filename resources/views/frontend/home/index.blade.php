  ...
  <!-- shop section -->
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="box">
                        <a href="/products/{{$product->id}}">
                            ...
                            {{-- <div class="rating" style="color: rgb(251, 48, 21)">
        ...
        <div class="box">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-5">
                        <div class="img-box">
                            <img src="frontend\images/banner2.png" alt>
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="detail-box">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="box ">
                        <div class="img-box">
                            <svg id="_30_Premium" data-name="30_Premium" height="512" viewBox="0 0 512 512"
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="img_container">
                            <div class="img-box">
                                <img src="frontend\images/gifts.png" alt>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-7">
    ...
    <section class="client_section layout_padding">
        ...
        <div class="container px-0">
            <div class="carousel  carousel-fade" id="customCarousel2" data-ride="carousel">
                ...
                <div class="carousel_btn-box">
                    <a class="carousel-control-prev" data-slide="prev" href="#customCarousel2" role="button">
                        <i class="fa fa-angle-left" aria-hidden="true"></i>
                        <span class="sr-only">Previous</span>
                    </a>
                    <a class="carousel-control-next" data-slide="next" href="#customCarousel2" role="button">
